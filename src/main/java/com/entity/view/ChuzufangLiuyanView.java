...
public class ChuzufangLiuyanView extends ChuzufangLiuyanEntity implements Serializable {
	...
	public ChuzufangLiuyanView() {

	}

	public ChuzufangLiuyanView(ChuzufangLiuyanEntity chuzufangLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, chuzufangLiuyanEntity);
