 ...
 */
@TableName("chuzufang")
public class ChuzufangView extends ChuzufangEntity implements Serializable {
	...
	public ChuzufangView() {

	}

	public ChuzufangView(ChuzufangEntity chuzufangEntity) {
		try {
			BeanUtils.copyProperties(this, chuzufangEntity);
