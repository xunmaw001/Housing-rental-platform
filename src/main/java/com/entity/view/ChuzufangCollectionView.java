 ...
 */
@TableName("chuzufang_collection")
public class ChuzufangCollectionView extends ChuzufangCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String chuzufangCollectionValue;
	...
	public ChuzufangCollectionView() {

	}

	public ChuzufangCollectionView(ChuzufangCollectionEntity chuzufangCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, chuzufangCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getChuzufangCollectionValue() {
				return chuzufangCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setChuzufangCollectionValue(String chuzufangCollectionValue) {
				this.chuzufangCollectionValue = chuzufangCollectionValue;
			}
