...
var centerMenu = [
    ...
    ,{
        name: '出租房收藏',
        url: '../chuzufangCollection/list.jsp'
    }
    ,{
        name: '预约看房订单',
        url: '../chuzufangOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '出租房',
        url: './pages/chuzufang/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/fangwuzulinpingtai/jsp/login.jsp";
