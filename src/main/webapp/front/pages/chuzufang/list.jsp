            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">出租房展示</span>
                        ...
                        <div class="row">
                            <div class="col-md-3" v-for="(item,index) in dataList" >
                                <div class="galry-grid grid-top-rgt">
                                    <a href="javascript:return false;"  @click="jumpCheck('../chuzufang/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            // 获取列表数据
            http.request('chuzufang/list', 'get', param, function(res) {
