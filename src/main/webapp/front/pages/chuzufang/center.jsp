    ...
    <ul id="category">
        <li v-for="(item,index) in centerMenu" v-bind:key="index" :class="index==0?'bbbb':''">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="chuzufangName" id="chuzufangName" lay-verify="required" placeholder="出租房名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="mianji" id="mianji"  lay-verify="required|double"   placeholder="面积(平米)" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="chuzufangPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="chuzufangPhoto" name="chuzufangPhoto"/>
							</div>
						</div>

						<div class="layui-form-item">
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="chuzufangPhotoUpload">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="chuzufangTypes" id="chuzufangTypes">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    <label class="layui-form-label">出租房原价/月</label>
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="chuzufangOldMoney" id="chuzufangOldMoney"  placeholder="出租房原价/月" autocomplete="off" class="layui-input" style="width: 500px">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    <label class="layui-form-label">现价/月</label>
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="chuzufangNewMoney" id="chuzufangNewMoney"  placeholder="现价/月" autocomplete="off" class="layui-input" style="width: 500px">
                        <div class="layui-form-mid layui-word-aux">
                            <i class="layui-icon" style="font-size: 20px;color: red;">&#xe65e;</i>
                            <a id="btn-recharge" href="javascript:void(0)">点我充值</a>
                        </div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="chuzufangClicknum" id="chuzufangClicknum"  lay-verify="required|integer"   placeholder="点击次数" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                upload.render({
                    ...
                    // 上传成功
                        ...
                        if (res.code == 0) {
                            ...
                            jquery('#chuzufangPhoto').val(url);
                            jquery('#chuzufangPhotoImg').attr('src', url);
                        } else {
                            layer.msg(res.msg, {
                                time: 2000,
                                icon: 5
                ...
                http.request(`chuzufang/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#chuzufangPhotoImg").attr("src", data.data.chuzufangPhoto);
                });
			   ...
			   function chuzufangTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=chuzufang_types", "GET", {}, (res) => {
					   if(res.code == 0){
