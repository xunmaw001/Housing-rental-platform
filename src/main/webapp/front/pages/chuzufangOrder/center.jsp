    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yuyueTime" id="yuyueTime"  lay-verify="required|date"   placeholder="预约看房日期" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="shijianduanTypes" id="shijianduanTypes">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="chuzufangOrderYesnoTypes" id="chuzufangOrderYesnoTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="chuzufangOrderYesnoText" id="chuzufangOrderYesnoText" lay-verify="required" placeholder="回复理由" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`chuzufangOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
