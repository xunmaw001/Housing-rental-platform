    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="chuzufangCollectionTypes" id="chuzufangCollectionTypes">
                                    <option v-for="item in chuzufangCollectionTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`chuzufangCollection/session`, 'get', {}, function (data) {
                    // 表单赋值
			   ...
			   function chuzufangCollectionTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=chuzufang_collection_types", "GET", {}, (res) => {
					   if(res.code == 0){
