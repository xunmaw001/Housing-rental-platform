...
<script>
    ...
    var tableName = "dictionaryChuzufangOrderYesno";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "chuzufang_order_yesno_types";
            data["dicName"] = "审核状态";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"chuzufang_order_yesno_types"}, (res) => {
                if(res.code == 0){
